...
public class MYSQLRaavareBatchDAO implements RaavareBatchDAO {
	...
	public RaavareBatchDTO getRaavareBatch(int rbId) throws DALException {
		try {
			CallableStatement getRB = Connector.getInstance().getConnection()
	...
	public void createRaavareBatch(RaavareBatchDTO raavarebatch) throws DALException {
		try {
			Connector.getInstance().doQuery("SELECT add_raavarebatch('" + raavarebatch.getRbId() + "','"
	...
	public void updateRaavareBatch(RaavareBatchDTO raavarebatch) throws DALException {
		try {
			Connector.getInstance().doUpdate("SELECT update_raavarebatch('" + raavarebatch.getRbId() + "','"
					+ raavarebatch.getRaavareId() + "','" + raavarebatch.getMaengde() + "');");
		} catch (SQLException e) {
			e.printStackTrace();
		}
