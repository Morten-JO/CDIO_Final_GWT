						...
						public void onClick(ClickEvent event) {
							...
							ok.addClickHandler(new ClickHandler() {
								...
								public void onClick(ClickEvent event) {
									...
									RaavareBatchDTO RB = new RaavareBatchDTO(Integer.parseInt(rbIdTxt.getText()), Integer.parseInt(raavareIdTxt.getText()), Double.parseDouble(maengdeTxt.getText()));
							...
							cancel.addClickHandler(new ClickHandler() {
								...
								public void onClick(ClickEvent event) {
									...
									raavareIdTxt.fireEvent(new KeyUpEvent() {}); // validation

									maengdeTxt.setText(maengde);
									 maengdeTxt.fireEvent(new KeyUpEvent() {});  // validation
